...
//==================================================================================================================
    ...
    //direction is set from he AI component
...
//=========================================================================================================================================
        ...
        if(st == State.Init)
        {
            using (StringReader reader = new StringReader(data))
            {
                ...
                {
                    if (line.Length == 0) break; //CHECK WHETHER IT WORKS
        ...
        if (st == State.Scatter)
        {
            ...
            using (StringReader reader = new StringReader(data))
            {
                while ((line = reader.ReadLine()) != null)
                {
                    if (line.Length == 0)
                    {
                        scatterWps = true; //We've reached the scatter waypoints
...
//==========================================================================================================================================================
    ...
    void RunAway()
    {
        ...
        if(Time.time >= _timeToWhite && Time.time >= _timeToToggleWhite)
